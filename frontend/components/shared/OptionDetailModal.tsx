...
export function OptionDetailModal({ option, isOpen, onClose, onEdit }: OptionDetailModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Option Details - {option.name}</DialogTitle>
          <DialogDescription>
            View option information and details.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid grid-cols-1 gap-6 mt-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block font-semibold text-sm text-gray-600 mb-1">Option ID</label>
